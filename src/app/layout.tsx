  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground relative overflow-x-hidden">
        <ParticlesCanvas />
        <TopNav />
        <main className="relative z-10 flex-1 mx-auto w-full max-w-[1400px] px-6 py-8">
          {children}
        </main>
        <footer className="relative z-10 mx-auto w-full max-w-[1400px] px-6 py-6 text-xs text-muted">
